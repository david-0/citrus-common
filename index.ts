...
export {IBulkOrder} from "./lib/entity/i-bulk-order";
export {ICustomerOrder} from "./lib/entity/i-customer-order";
export {ICustomerOrderItem} from "./lib/entity/i-customer-order-item";
export {IGpsLocation} from "./lib/entity/i-gps-location";
export {IOpeningHours} from "./lib/entity/i-opening-hours";
export {IPickupLocation} from "./lib/entity/i-pickup-location";
export {IPricedArticle} from "./lib/entity/i-priced-article";
export {IRole} from "./lib/entity/i-role";
...
export {IRequest} from "./lib/request/i-request";
export {IRequestField} from "./lib/request/i-request-field";
